...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['cobrar_pedido'])) {
    ...
    try {
        ...
        // Corregido: 'COBRADO' va directo en el SQL, por lo tanto bind_param usa 4 parámetros ("idss")
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['cancelar_pedido'])) {
    ...
    try {
        ...
        // Corregido: 'CANCELADO' va directo en el SQL, por lo tanto bind_param usa 4 parámetros ("idss")
...
<head>
    ...
    <title>Caja (Admin) - Taquería Novillero</title>
    <style>
        body { 
