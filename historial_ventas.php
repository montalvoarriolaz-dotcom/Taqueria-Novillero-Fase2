...
<head>
    ...
    <style>
        ...
        .btn-regresar { display: block; width: 280px; margin: 25px auto 0 auto; padding: 12px; background-color: #3d2514; color: #ffffff; text-decoration: none; text-align: center; font-weight: bold; border-radius: 12px; text-transform: uppercase; box-shadow: 0 4px 0 #1c1007; }
...
<div class="container">
    <h2>Historial de Ventas (Trabajador)</h2>
                    ...
                    <tr class="<?php echo $esCancelado ? 'cancelado-row' : ''; ?>">
                        ...
                        <td style="text-align: center;">
                            <div class="acciones-wrapper">
                                ...
                                <form action="historial_pedidos.php" method="POST" style="margin:0;">
    ...
    <a href="panel_trabajador.php" class="btn-regresar">← Volver al Panel Trabajador</a>
</div>
