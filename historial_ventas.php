...
// Validar seguridad de administrador/trabajador
...
<head>
    ...
    <style>
        ...
        .container {
            ...
            border: 2px solid #d32f2f; /* Borde rojo quemado */
        }
        ...
        th {
            background-color: #d32f2f; /* Encabezado Rojo */
            color: #ffffff;
            padding: 12px;
            text-transform: uppercase;
            font-size: 11px;
...
<body>
    ...
    <div class="container">
        ...
        <p class="sub-titulo">MÓDULO DE CONSULTA</p>
